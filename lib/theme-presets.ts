...
export const themePresets: Record<string, ThemePreset> = {
  ...
  "linear": {
    ...
    styles: {
      light: {
        "logo": "#242428",
        "logo-background": "#e8e8ff",
        "background": "#f7f7f8",
        "foreground": "#242428",
        "card": "#ffffffad",
        "card-foreground": "#242428",
        "popover": "#ffffffd9",
        "popover-foreground": "#242428",
        "primary": "#5e6ad2",
        "primary-foreground": "#ffffff",
        "secondary": "#eeeeef",
        ...
        "chart-5": "#2563eb",
        "sidebar": "#fbfbfccc",
        "sidebar-foreground": "#242428",
        "sidebar-primary": "#5e6ad2",
        "sidebar-primary-foreground": "#ffffff",
        "sidebar-accent": "#ededfe",
        "sidebar-accent-foreground": "#4545a9",
        "sidebar-border": "#d8d8e6b3",
        "sidebar-ring": "#5e6ad2",
        "radius": "0.45rem",
        "shadow-highlight": "inset 0 1px 0 hsl(0 0% 100% / 0.9), inset 0 -1px 0 hsl(240 20% 60% / 0.06)",
        "shadow-2xs": "0 1px 1px hsl(240 20% 18% / 0.03)",
        "shadow-xs": "0 1px 2px hsl(240 20% 18% / 0.04)",
        "shadow-sm": "0 3px 8px hsl(240 20% 18% / 0.07)",
        "shadow": "0 6px 16px hsl(240 20% 18% / 0.08)",
        "shadow-md": "0 10px 24px hsl(240 20% 18% / 0.10)",
        "shadow-lg": "0 16px 38px hsl(240 20% 18% / 0.12)",
        "shadow-xl": "0 24px 54px hsl(240 20% 18% / 0.14)",
        "shadow-2xl": "0 34px 76px hsl(240 20% 18% / 0.16)",
      },
      dark: {
        "logo": "#f7f7f8",
        "logo-background": "#5e6ad2",
        "background": "#171719",
        "foreground": "#f7f7f8",
        "card": "#242429b8",
        ...
        "chart-5": "#60a5fa",
        "sidebar": "#1d1d20c9",
        "sidebar-foreground": "#f7f7f8",
        "sidebar-primary": "#8b8bf9",
        "sidebar-primary-foreground": "#171717",
        "sidebar-accent": "#2b2b4b",
        "sidebar-accent-foreground": "#d9d9ff",
        "sidebar-border": "#56565d91",
        "sidebar-ring": "#8b8bf9",
        "shadow-highlight": "inset 0 1px 0 hsl(0 0% 100% / 0.10), inset 0 -1px 0 hsl(0 0% 0% / 0.24)",
        "shadow-2xs": "0 1px 1px hsl(0 0% 0% / 0.20)",
        "shadow-xs": "0 2px 4px hsl(0 0% 0% / 0.24)",
        "shadow-sm": "0 4px 10px hsl(0 0% 0% / 0.30)",
        "shadow": "0 8px 18px hsl(0 0% 0% / 0.34)",
        "shadow-md": "0 12px 28px hsl(0 0% 0% / 0.38)",
        "shadow-lg": "0 18px 42px hsl(0 0% 0% / 0.44)",
        "shadow-xl": "0 28px 58px hsl(0 0% 0% / 0.48)",
        "shadow-2xl": "0 38px 80px hsl(0 0% 0% / 0.54)",
      },
    },
  },
  ...
  "neumorphism": {
    ...
    styles: {
      light: {
        "logo": "#4a5362",
        "logo-background": "#e7ecf3",
        "content": "#e7ecf3",
        "background": "#e7ecf3",
        "foreground": "#4a5362",
        "card": "#e7ecf3",
        "card-foreground": "#4a5362",
        "popover": "#e7ecf3",
        "popover-foreground": "#4a5362",
        "primary": "#6878cc",
        "primary-foreground": "#ffffff",
        "secondary": "#eef2f7",
        "secondary-foreground": "#4a5362",
        "muted": "#dce3ec",
        "muted-foreground": "#7b8798",
        "accent": "#dfe6f0",
        "accent-foreground": "#4a5362",
        "destructive": "#d66464",
        "destructive-foreground": "#ffffff",
        "border": "#e7ecf3",
        "input": "#e1e7ef",
        ...
        "chart-5": "#7190ca",
        "sidebar": "#e7ecf3",
        "sidebar-foreground": "#4a5362",
        "sidebar-primary": "#6878cc",
        "sidebar-primary-foreground": "#ffffff",
        "sidebar-accent": "#dfe6f0",
        "sidebar-accent-foreground": "#4a5362",
        "sidebar-border": "#e7ecf3",
        "sidebar-ring": "#8a98e3",
        "radius": "1.1rem",
        "shadow-highlight": "inset 1px 1px 0 hsl(0 0% 100% / 0.78), inset -1px -1px 0 hsl(220 22% 58% / 0.10)",
        "shadow-2xs": "2px 2px 4px #c7ced8, -2px -2px 4px #ffffff",
        "shadow-xs": "3px 3px 6px #c7ced8, -3px -3px 6px #ffffff",
        "shadow-sm": "5px 5px 10px #c7ced8, -5px -5px 10px #ffffff",
        "shadow": "7px 7px 14px #c7ced8, -7px -7px 14px #ffffff",
        "shadow-md": "10px 10px 20px #c7ced8, -10px -10px 20px #ffffff",
        "shadow-lg": "14px 14px 28px #c7ced8, -14px -14px 28px #ffffff",
        "shadow-xl": "18px 18px 36px #c7ced8, -18px -18px 36px #ffffff",
        "shadow-2xl": "24px 24px 48px #c7ced8, -24px -24px 48px #ffffff",
      },
      dark: {
        "logo": "#dce1e8",
        "logo-background": "#303640",
        "background": "#252a32",
        "foreground": "#dce1e8",
        "card": "#252a32",
        ...
        "sidebar-primary": "#9ba8ff",
        "sidebar-primary-foreground": "#20242b",
        "sidebar-accent": "#303640",
        "sidebar-accent-foreground": "#dce1e8",
        "sidebar-border": "#252a32",
        "sidebar-ring": "#9ba8ff",
        "shadow-highlight": "inset 1px 1px 0 hsl(0 0% 100% / 0.08), inset -1px -1px 0 hsl(0 0% 0% / 0.24)",
        "shadow-2xs": "2px 2px 4px #1a1e24, -2px -2px 4px #303640",
        "shadow-xs": "3px 3px 6px #1a1e24, -3px -3px 6px #303640",
        "shadow-sm": "5px 5px 10px #1a1e24, -5px -5px 10px #303640",
        "shadow": "7px 7px 14px #1a1e24, -7px -7px 14px #303640",
        "shadow-md": "10px 10px 20px #1a1e24, -10px -10px 20px #303640",
        "shadow-lg": "14px 14px 28px #1a1e24, -14px -14px 28px #303640",
        "shadow-xl": "18px 18px 36px #1a1e24, -18px -18px 36px #303640",
        "shadow-2xl": "24px 24px 48px #1a1e24, -24px -24px 48px #303640",
      },
    },
  },
  ...
  "memphis": {
    ...
    styles: {
      light: {
        ...
        "sidebar-primary": "#2864dc",
        "sidebar-primary-foreground": "#ffffff",
        "sidebar-accent": "#ff6b6b",
        "sidebar-accent-foreground": "#202124",
        "sidebar-border": "#202124",
        "sidebar-ring": "#2864dc",
        "radius": "1.2rem",
        "shadow-highlight": "inset 2px 2px 0 hsl(0 0% 100% / 0.58)",
        "shadow-2xs": "2px 2px 0 #202124",
        "shadow-xs": "3px 3px 0 #202124",
        "shadow-sm": "4px 4px 0 #202124",
        "shadow": "5px 5px 0 #202124",
        "shadow-md": "6px 6px 0 #202124",
        "shadow-lg": "8px 8px 0 #202124",
        "shadow-xl": "10px 10px 0 #202124",
        "shadow-2xl": "12px 12px 0 #202124",
      },
      dark: {
        "logo": "#fff6e8",
        "logo-background": "#ff6b6b",
        "background": "#201d2b",
        "foreground": "#fff6e8",
        "card": "#2b2740",
        "card-foreground": "#fff6e8",
        "popover": "#2b2740",
        "popover-foreground": "#fff6e8",
        "primary": "#68b5ff",
        "primary-foreground": "#17141f",
        "secondary": "#ffe66d",
        "secondary-foreground": "#17141f",
        "muted": "#37314c",
        "muted-foreground": "#c7bfd2",
        "accent": "#ff8c8c",
        "accent-foreground": "#17141f",
        "destructive": "#fff6e8",
        "destructive-foreground": "#17141f",
        "border": "#fff6e8",
        "input": "#fff6e8",
        "ring": "#68b5ff",
        "chart-1": "#68b5ff",
        ...
        "sidebar-primary": "#68b5ff",
        "sidebar-primary-foreground": "#17141f",
        "sidebar-accent": "#ff8c8c",
        "sidebar-accent-foreground": "#17141f",
        "sidebar-border": "#fff6e8",
        "sidebar-ring": "#68b5ff",
        "shadow-highlight": "inset 2px 2px 0 hsl(0 0% 100% / 0.12)",
        "shadow-2xs": "2px 2px 0 #0e0d14",
        "shadow-xs": "3px 3px 0 #0e0d14",
        "shadow-sm": "4px 4px 0 #0e0d14",
        "shadow": "5px 5px 0 #0e0d14",
        "shadow-md": "6px 6px 0 #0e0d14",
        "shadow-lg": "8px 8px 0 #0e0d14",
        "shadow-xl": "10px 10px 0 #0e0d14",
        "shadow-2xl": "12px 12px 0 #0e0d14",
      },
    },
  },
};
